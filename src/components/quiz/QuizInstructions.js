...
const QuizInstructions = () => (
    <Fragment>
        ...
        <div className="instructions container">
            ...
            <p>This is Afy. i am the Instructor . Ensure you read this guide from start to finish.</p>
            <ul className="browser-default" id="main-list">
                <li>This exam has a duration of 15 minutes and ends as soon as your time elapses.</li>
                ...
                <li>you can quit (or retire from) the game at any time. In that case your score will be revealed afterwards.</li>
                <li>The timer starts as soon as the game loads.</li>
                <li>Let's do this if you think you've got what it takes?</li>
            </ul>
            <div>
                <span className="left"><Link to="/">No take me back</Link></span>
                <span className="right"><Link to="/play/quiz">Okay, Click here of the exam! Best of luck</Link></span>
            </div>
        </div>
    </Fragment>
);
